  ...
  return (
    <div className="space-y-20 animate-[fadeIn_0.5s_ease-out]">
      ...
      <section className="space-y-6">
        ...
        <h4 className="text-lg font-bold text-ink">Behavioral Coding</h4>
        <p>
        ...
        <h4 className="text-lg font-bold text-ink">Visual Coding</h4>
        <p>
        ...
        <h4 className="text-lg font-bold text-ink">Data Analysis</h4>
        <p>
